...
class DegreeForm(forms.ModelForm):
    ...
    label = forms.CharField(
        ...
        label=_("Intitulé réglementaire :"),
        help_text=_("(équivalent programme ROF)")
    )
        ...
        self.helper.layout = Layout(
            Div(
                Div(
                    Div(
                        Div(
                            'degree_type',
                            'degree_type_label',
                            css_class='parent div-child-disp-flex \
                            label-child-w2'
                        ),
                        css_class="item-65",
                    ),
                    Div(
                        Div(
                            ...
                            HTML("""
                               <a href="{% url 'degree:degree_create'  %}"
                               class="btn btn-primary bottom-2em item"
                                style="width:10em;margin-bottom:0.5em;">
                                    Créer un diplôme</a>
                            """),

                            Button('rof', _('[Référentiel OF]'),
                                   style="width:10em"),
                    ...
                    Div(
                        ...
                        Div(
                            ...
                            Div(
                                ...
                                Field('end_year'),
                                style="width:65%",
                                css_class="div-child-disp-flex \
                                    label-child-w2 dir-col"
                ...
                Div(
                    ...
                    Div('institutes', style="display:none"),
                    HTML(
            ...
            Div(
                FormActions(
                    Submit('add', _('Valider et fermer la fiche'),
                           css_class=" btn btn-sm", style="width:30%",
                           onclick="_isEdited=false"),
                    HTML("""
                        <a style="width:30%" class="btn-primary btn btn-sm"
                        href="{% url 'degree:list' filter='current' cmp='none'
                        %}">Annuler et fermer la fiche</a>
                    """),
                ),
...
class DegreeTypeForm(forms.ModelForm):
    ...
    Degree type form
    """
    is_in_use = forms.BooleanField(
        required=False, initial=True, label=_("En service"))
            ...
            Div(
                Div(
                    ...
                    <div class="controls col-md-3">
                        <input class="form-control" id="id_degree_type"
                            name="id_degree_type" readonly=True>
                    </div>
                            """),
