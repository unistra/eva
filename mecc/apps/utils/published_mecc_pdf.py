...
class PublishedMeccPdf:
    ...
    def __init__(self, training, file):
        ...
        self.p_page_width = (self.p_width - self.margin * 2)
        self.p_page_height = (self.p_height - self.margin * 2)
        self.buffer = file
        self.story = []
        self.doc_setup()
        self.make_styles()
    ...
    def doc_setup(self):
        ...
        frame_landscape = Frame(
            self.doc.leftMargin,
            self.margin,
            landscape_width - (self.margin * 2),
            landscape_height - (self.margin * 2),
            id='frame_landscape',
            showBoundary=0
        )
        ...
        self.doc.addPageTemplates([portrait_template, landscape_template])

    def add_metadata(self, canvas, doc):
        canvas.setTitle("MECC {} - {}".format(self.year, self.training.label))
    ...
    def make_styles(self):
        ...
        self.styles.add(ParagraphStyle(name='SmallNormal', fontSize=8))
