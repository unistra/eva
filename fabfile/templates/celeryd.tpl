...
# Beat Settings #
#################
#User and group to run beat as
CELERYBEAT_USER="django"
CELERYBEAT_GROUP="di"

# Path to beat log and pid files
CELERYBEAT_LOG_FILE="/var/log/celery/beat-mecc.log"
CELERYBEAT_PID_FILE="/var/run/celery/beat-mecc.pid"

# Extra command-line arguments to the beat
CELERYBEAT_OPTS="--schedule=/var/run/celery/celerybeat-mecc-schedule"
